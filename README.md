...
Project page for **CausalSplat: Towards Comprehensive Hierarchical Reasoning in 3D Gaussian Splatting**.
...
Figures are sourced from `CausalSplat/` LaTeX project and copied to `static/images/`.
